...
t1 = not(Assign4.loadData("junk.txt", "stuff.txt"))
t2 = len(Assign4.allAirports) == 0
t3 = False
try:
...
t1 = Assign4.loadData("airports.txt", "flights.txt")
total = 0
for i in Assign4.allFlights:
    total += len(Assign4.allFlights[i])
if t1 and len(Assign4.allAirports) == 37 and total == 146:
...
t1 = Assign4.getAirportByCode("ORD")
...
cf = Assign4.findAllCityFlights("Toronto")
cfs = ""
for f in cf:
...
cf = Assign4.findAllCountryFlights("Brazil")
cfs = ""
for f in cf:
    cfs += f.getFlightNumber() + " "
...
f1 = Assign4.findFlightBetween(Assign4.getAirportByCode("PVG"), Assign4.getAirportByCode("YOW"))
f2 = Assign4.findFlightBetween(Assign4.getAirportByCode("LAX"), Assign4.getAirportByCode("DTW"))
...
f1 = Assign4.findFlightBetween(Assign4.getAirportByCode("DEL"), Assign4.getAirportByCode("YYZ"))
...
f1 = Assign4.allFlights["YYZ"][1]
f2 = Assign4.allFlights["BOG"][1]
f3 = Assign4.allFlights["MEX"][3]
t1 = Assign4.findReturnFlight(f1)
t2 = Assign4.findReturnFlight(f2)
t3 = Assign4.findReturnFlight(f3)
